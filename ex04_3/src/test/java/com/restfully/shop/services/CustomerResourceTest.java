...
public class CustomerResourceTest {
  ...
  final String BASE_URI = "http://localhost:8080/services/customers/europe-db";
  Client client;
  Response response;
  ...
  public void testCreateANewCustomer() throws Exception {
    ...
    assertThat(response.getLocation().toString(), is("http://localhost:8080/services/customers/europe-db/1"));
  }
